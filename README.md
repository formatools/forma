...
6. [External deps catalogs](docs/DEPS-CATALOG.md) · [Target plugins](docs/TARGET-PLUGINS.md) (type-owned, Bazel-like; examples `10-target-plugins`, `11-metro-di`, `14-google-firebase`) · [Google first-party libraries](docs/GOOGLE-LIBRARIES.md) (AndroidX / Firebase coverage matrix, F-114) · [Navigation abstraction](docs/NAVIGATION-ABSTRACTION.md) (presentation ports vs `navigationRes`, F-102) · [Call-site surface](docs/CALL-SITE-SURFACE.md) (Unit DSLs + flag inventory) · [Fleet tooling](docs/FLEET-TOOLING.md) (check/generate Gradle tasks + core APIs, F-084/F-088) · [Principle audit](docs/PRINCIPLE-AUDIT.md) (F-085) · [Compose](docs/COMPOSE.md) · [Environment](docs/ENV.md)
