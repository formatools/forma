...
package tools.forma.sample.common.progressbar.viewbinding
...
import tools.forma.sample.common.extensions.android.util.getString
import tools.forma.sample.common.progressbar.viewbinding.databinding.ViewProgressDialogBinding
...
class ProgressBarDialog(
    context: Context
) : AlertDialog(context, tools.forma.sample.common.progressbar.res.R.style.CustomProgressDialog) {
