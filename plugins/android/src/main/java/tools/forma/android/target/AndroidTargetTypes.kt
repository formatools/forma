 ...
 * Ids are unique even when nameSuffix collides (e.g. "library" used by JVM `library()` target).
...
object AndroidTargetTypes {
    ...
    val jvmLibrary: TargetType = targetType("jvm.library", "library") // JVM library() consumer (suffix shared with historical androidLibrary)
